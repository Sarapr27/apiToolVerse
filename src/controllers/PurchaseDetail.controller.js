const { PurchaseDetail, PurchaseOrder, Product, PurchaseCart } = require('../db');
...
const createPurchaseDetail = async (req, res) => {
  ...
  try {
    ...
    console.log('el purchase Detail creado', createdDetail)
